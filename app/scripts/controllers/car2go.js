    ...
    .controller('Car2goCtrl', [
      ...
      function(
        ...
        var getDurationAndFeeExact = function() {
          ...
          if (totalFeeMinutes >= feeHour) {
            totalFeeMinutes = feeHour;
            minutesBilled = 0;
            hoursBilled++;
          }

          // check to see if it is cheaper to rent for the full day
          if (totalFeeMinutes + totalFeeHours >= feeDay) {
            totalFeeMinutes = 0;
            minutesBilled = 0;
            totalFeeHours = 0;
            hoursBilled = 0;
          ...
          // fee billed
          var totalFee = totalFeeMinutes + totalFeeHours + totalFeeDays;
        ...
        $scope.getFeeStanding = function() {
          return $scope.rental.timeStanding * car2gotariff.parking;
        };
