...
/**
 * @ngdoc service
 * @name c2gyoApp.bookndrivetariffbasic
 * @description
 * # bookndrivetariffbasic
 * Constant in the c2gyoApp.
 */
angular.module('c2gyoApp')
  .constant('bookndrivetariffbasic', {
    'resolution': 'h',
    'cityflitzer': {
      'time': {
        '1': [
