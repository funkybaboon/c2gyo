...
describe('Controller: SmCtrl', function() {
  ...
  it('should calculate the correct price using the datetimepicker', function() {
    ...
    scope.rental.tariff.sm = 'business';
