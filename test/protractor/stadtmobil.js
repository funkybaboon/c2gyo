describe('test stadtmobil input fields', function() {
  ...
  it('should calculate a price with all checkboxes ticked', function() {
    element(by.id('tariff.classic')).click();
